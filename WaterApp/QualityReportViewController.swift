//
//  QualityReportViewController.swift
//  WaterApp
//
...
class QualityReportViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        if (pickerView == waterConditionPicker) {
            ...
            let myTitle = NSAttributedString(string: titleData, attributes: [NSFontAttributeName:UIFont.systemFont(ofSize: 10),NSForegroundColorAttributeName:UIColor.black])
            return myTitle
        } else {
    ...
    @IBAction func createReportPress(_ sender: Any) {
        ...
        let infoString = "WaterType:  \(waterType), Virus PPM:  \(virusPPM.text ?? "NA")), Contaminant PPM:  \(contamPPM.text ?? "NA"))"
